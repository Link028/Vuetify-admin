  ...
  >
    <v-layout wrap>
      ...
      <v-flex
        ...
        sm6
      >
        <c-visual-card title="Drag List - Base">
      ...
      <v-flex
        ...
        sm6
      >
        <c-visual-card title="Drag List - Images">
          <template slot="card-content">
            <draggable
              v-model="images"
              class="grid"
      ...
      <v-flex
        ...
        md3
      >
        <c-visual-card title="Drag List - Group1">
          <template slot="card-content">
            <draggable
      ...
      <v-flex
        ...
        md3
      >
        <c-visual-card title="Drag List - Group2">
          <template slot="card-content">
            <draggable
              :options="groupDragOptions"
              v-model="list2"
      ...
      <v-flex
        ...
        md6
      >
        <c-visual-card title="Drag List - Data">
          <template slot="card-content">
            <v-layout wrap>
              <v-flex xs6>
                <h4>List1</h4>
